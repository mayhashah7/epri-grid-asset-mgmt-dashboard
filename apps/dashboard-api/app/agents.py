...
ORCHESTRATOR_NAME = "gam-orchestrator"

# Full AMI agent fabric (12 total: orchestrator + 11 specialists)
AGENT_ROSTER = [
    {"name": "gam-orchestrator", "domain": "routing", "icon": "🛠️", "color": "#10b981"},
    {"name": "gam-asset-image-analysis", "domain": "imaging", "icon": "📷", "color": "#34d399"},
    {"name": "gam-inspection-prioritization", "domain": "inspection", "icon": "🎯", "color": "#10b981"},
    {"name": "gam-maintenance-optimization", "domain": "maintenance", "icon": "🔧", "color": "#059669"},
    {"name": "gam-overhead-line-design-qa", "domain": "design", "icon": "📐", "color": "#22c55e"},
    {"name": "gam-vegetation-management", "domain": "vegetation", "icon": "🌳", "color": "#15803d"},
    {"name": "gam-condition-monitoring", "domain": "monitoring", "icon": "📊", "color": "#0d9488"},
    {"name": "gam-rating-breach-prediction", "domain": "thermal", "icon": "🌡️", "color": "#f59e0b"},
    {"name": "gam-transformer-failure-risk", "domain": "transformer", "icon": "⚡", "color": "#dc2626"},
    {"name": "gam-transformer-overload", "domain": "overload", "icon": "🔥", "color": "#ea580c"},
    {"name": "gam-underground-cable-health", "domain": "cable", "icon": "🔌", "color": "#0ea5e9"},
]
...
class FoundryAgentRunner:
    ...
    async def _mock_chat(self, *, text: str, persona: str | None, case_id: str | None) -> AsyncIterator[dict]:
        ...
        _routes = [
            (["asset", "image", "analysis"], "imaging", "gam-asset-image-analysis"),
            (["inspection", "prioritization"], "inspection", "gam-inspection-prioritization"),
            (["maintenance", "optimization"], "maintenance", "gam-maintenance-optimization"),
            (["overhead", "line", "design"], "design", "gam-overhead-line-design-qa"),
            (["vegetation", "management"], "vegetation", "gam-vegetation-management"),
            (["condition", "monitoring"], "monitoring", "gam-condition-monitoring"),
            (["rating", "breach", "prediction"], "thermal", "gam-rating-breach-prediction"),
            (["transformer", "failure", "risk"], "transformer", "gam-transformer-failure-risk"),
            (["transformer", "overload"], "overload", "gam-transformer-overload"),
            (["underground", "cable", "health"], "cable", "gam-underground-cable-health"),
        ]
        kind, target = "imaging", "gam-asset-image-analysis"
...
EVENT_TO_PROMPT: dict[str, tuple[str, str]] = {
    "drone-survey": ("Imagery batch flagged 14 insulator anomalies on circuit T-44", "gam-asset-image-analysis"),
    "vegetation-spike": ("LiDAR shows 3 spans below clearance on OH-12 corridor", "gam-vegetation-management"),
    "dga-spike": ("Acetylene rose 4× on bank TX-09 — investigate", "gam-transformer-failure-risk"),
    "thermal-breach": ("Heat dome forecast → 6 lines projected over rating in 72h", "gam-rating-breach-prediction"),
    "overload-event": ("TX-22 at 138% nameplate, oil temp climbing", "gam-transformer-overload"),
    "ug-cable-pd": ("PD on cable C-301 trending up — aging risk", "gam-underground-cable-health"),
    "inspection-batch": ("412 inspections pending — propose priority order", "gam-inspection-prioritization"),
    "design-audit": ("Audit OH-line designs in past 12 months for code conformance", "gam-overhead-line-design-qa"),
}
