# gam-vegetation-management

**Domain:** Grid Asset Management & Performance → vegetation

**Mission:** Satellite + LiDAR vegetation risk → optimized trim cycles

## Background
Analyzes satellite imagery, LiDAR, and growth models to assess encroachment risk along OH lines. Prioritizes trim activities by risk × cost × environmental impact.
