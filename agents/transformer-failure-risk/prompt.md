# gam-transformer-failure-risk

**Domain:** Grid Asset Management & Performance → transformer

**Mission:** DGA + load profile → failure-risk index

## Background
Risk-scores transformers from DGA, oil quality, load patterns, and age. Tracks degradation trajectories and recommends replacement priorities.
