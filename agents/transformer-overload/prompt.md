# gam-transformer-overload

**Domain:** Grid Asset Management & Performance → overload

**Mission:** Live overload detection + load-transfer plan

## Background
Detects transformers operating beyond rating in real time, projects thermal aging impact, and proposes load-transfer or curtailment to neighbors.
